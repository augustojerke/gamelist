...
export async function getGames(limit: number, offset: number, searchGameName: string): AxiosPromise<Game[]> {
  let bodyParams = 
    `fields name, aggregated_rating, cover.url, first_release_date, genres.name; 
